...
[에어컨 시공 진행 과정 (사진+번호 카드 8개) - 에어컨 서비스 페이지 공통]
  aircon-process-1.jpg ~ aircon-process-8.jpg
  순서: 01 기기 작동 및 고장진단 / 02 실내기 완전 분해 / 03 열교환기 고압세척 / 04 부품 세척
        05 건조 작업 / 06 실내기 재조립 / 07 실외기 사이클 진단·점검 / 08 작동 테스트 및 최종점검
  - 가로형 4:3 비율 권장. 이 데이터가 없는 카테고리(석재보수 등)는 기존 4단계 아이콘형으로 자동 표시됩니다.
